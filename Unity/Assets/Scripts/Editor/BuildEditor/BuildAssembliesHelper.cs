...
namespace ET
{
    public static class BuildAssembliesHelper
    {
        ...
        public static void BuildModel(CodeOptimization codeOptimization, GlobalConfig globalConfig)
        {
            ...
            File.Copy(Path.Combine(Define.BuildOutputDir, "Model.dll"), Path.Combine(SettingsUtil.GetHotUpdateDllsOutputDirByTarget(EditorUserBuildSettings.activeBuildTarget), $"Model.dll"), true);
            File.Copy(Path.Combine(Define.BuildOutputDir, "Model.pdb"), Path.Combine(SettingsUtil.GetHotUpdateDllsOutputDirByTarget(EditorUserBuildSettings.activeBuildTarget), $"Model.pdb"), true);
            
            Debug.Log($"copy Model.dll to {SettingsUtil.GetHotUpdateDllsOutputDirByTarget(EditorUserBuildSettings.activeBuildTarget)} success!");
        ...
        public static void BuildHotfix(CodeOptimization codeOptimization, GlobalConfig globalConfig)
        {
            ...
            File.Copy(Path.Combine(Define.BuildOutputDir, "Hotfix.dll"), Path.Combine(SettingsUtil.GetHotUpdateDllsOutputDirByTarget(EditorUserBuildSettings.activeBuildTarget), $"Hotfix.dll"), true);
            File.Copy(Path.Combine(Define.BuildOutputDir, "Hotfix.pdb"), Path.Combine(SettingsUtil.GetHotUpdateDllsOutputDirByTarget(EditorUserBuildSettings.activeBuildTarget), $"Hotfix.pdb"), true);
            
            Debug.Log($"copy Hotfix.dll to {SettingsUtil.GetHotUpdateDllsOutputDirByTarget(EditorUserBuildSettings.activeBuildTarget)} success!");
